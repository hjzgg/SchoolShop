 ...
 * @author HJZ
 */
public class MyBabyDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(picName!=null){//从会话中删除信息
                if(mp.containsKey(picName))  mp.remove(picName);
                if(mp_money.containsKey(picName)) mp_money.remove(picName);
        }
    }
