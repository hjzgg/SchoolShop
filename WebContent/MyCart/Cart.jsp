             ...
             <center>
                    ...
                    <table id="myBabyTable">
                       ...
                       %>
                               <tr>
                                   <td>
                                       <a href="../mainChooseFood/showChooseFood.jsp?choosefood=<%=key%>"><img height="73" width="73" title="<%=key%>"   src="<%="http://" + ip.getHostAddress() + ":" + port + request.getContextPath() + "/GetPicture?picName=" + key%>"/></a>
                                   </td>
                                   <td>
                                       <table>
                                           <tr>
