...
<html>
            ...
            function submitEvaluate(picName, row){//对该食品进行评价
                    ...
                    xmlhttp.onreadystatechange=function(){
                        if (xmlhttp.readyState==4 && xmlhttp.status==200){
                            ...
                            responseText = responseText.match(/[\S]+/);
    ...
    <body style="background-image: url(../白纸木板.jpg); background-size: 1365px 610px">
        <center>
                <br><br>
                ...
                %>
                              <tr>
                                    <td>
                                        <a href="../mainChooseFood/showChooseFood.jsp?choosefood=<%=baby.getPicName()%>"><img height="73" width="73" title="<%=baby.getPicName()%>"   src="<%="http://" + ip.getHostAddress() + ":" + port + request.getContextPath() + "/GetPicture?picName=" + baby.getPicName()%>"/></a>
                                    </td>
                                    <td>
                                        <table>
                                            <tr>
                                    ...
                                    <td style="text-align: center; background: #F90" colspan="2">
                                        <div id="<%="evaluate"+row%>" style="display: none">
                                            ...
                                            <div id="<%="evaluateOK"+row%>" style="display: none">
                                                ...
                                                <div style=" text-align: right"><button onclick="document.getElementById('<%="evaluate"+row%>').style.display='none'">收起评论</button></div>
                                            </div>
                                            <!--评论失败-->
                                            <div id="<%="evaluateNO"+row%>" style="display: none">
                                                <p style="color: #a11115; font-weight: 700; font-family: verdana,arial; font-size: 40px">评论失败</p>
                                            </div>
                                        </div>
                                    </td>
                                <tr>
