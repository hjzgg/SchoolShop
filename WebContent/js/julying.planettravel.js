...
;(function($){
	...
	$.fn.planetTravel.defaults = {
		...
		flyStarImage		: [ ['../images/star-fly-1.png' , 23 ,23 ] ],/*����ͼƬ��ַ.��ַ����ȣ��߶�*/	
		flyStartBright	 	: Array( 0.6 , 1 ) ,  /*star ���ȷ�Χ*/ 
		flyDuration			: 15000 , /*���Ƿ��е�ʱ��,��λ ms �����������Ƿ����ٶȵĿ���*/
		flyMakeStarTime		: 5000 , /*����starʱ����,��λ ms.*/
		flyMakestarNum		: 2 ,  /*ÿ�β�����ٸ�star,��λ ms.*/
		
		flashStarImage		: [ ['../images/star-flash-1.png' , 30 ,27 ] , [ '../images/star-flash-2.png' , 40 ,40 ], [ '../images/star-flash-2.png' , 40 ,40 ] ],/*����ͼƬ��ַ ����ַ����ȣ��߶�  */
		flashStarDensity	: 0.3 /* ��˸���ǵ��ܶȡ� ��λ�������� ÿ100ƽ������ ����� ��˸���ǵ�ƽ������������100px * 100px ����ڣ�*/
	};	
})(jQuery);